...
padding-bottom: 9999px 来拉长底部

margin-bottom: -9999px 来相互抵消

再设置 BFC: overflow: hidden;
...
- 基础选择器  *  p   .info   #infoE
- 组合选择器  E,F  多元素  E F 所有后代   (E>F ，匹配所有E元素的子元素F)    E+F 相邻同辈(匹配所有紧随 E元素之后的同级元素F) E ~F  一般同辈 (匹配任何在E元素之后的同级F元素)
- 属性选择器   a[href]
- 伪类 伪元素
